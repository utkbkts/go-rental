export const resetPasswordTemplate = (username: string, url: string) => `
  ...
  <head>
    ...
    <style type="text/css" rel="stylesheet" media="all">
      ...
      .button--black {
        ...
        border-right: 18px solid #2e2e2e;
        border-bottom: 10px solid #2e2e2e;
        border-left: 18px solid #2e2e2e;
      }
                              ...
                              >
                                <tr>
                                  <td align="center">
                                    <a
                                      href="${url}"
                                      class="f-fallback button button--black"
                                      target="_blank"
                                      >Reset Password</a
                                    >
                                  </td>
